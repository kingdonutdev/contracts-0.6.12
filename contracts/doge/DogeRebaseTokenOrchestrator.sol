...
import "./DogeRebaseTokenMonetaryPolicy.sol";
 ...
 */
contract DogeRebaseTokenOrchestrator is OwnableUpgradeSafe {
    ...
    DogeRebaseTokenMonetaryPolicy public policy;

    function setMonetaryPolicy(address _policy)
        public
        onlyOwner
    {
        policy = DogeRebaseTokenMonetaryPolicy(_policy);
    }
    ...
    {
        __Ownable_init();
        policy = DogeRebaseTokenMonetaryPolicy(policy_);
    }
